    ...
    <DashboardLayout>
      <div className="p-8 space-y-8 animate-in fade-in duration-500">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div>
            <h1 className="text-4xl font-bold text-foreground font-space mb-2">Agenda</h1>
            <p className="text-muted-foreground">Gerencie suas publicações agendadas para os próximos dias.</p>
          </div>
          <Link to="/campanha">
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 w-32 p-4 rounded-2xl border transition-all text-center space-y-1 ${
                  isSelected 
                    ? "bg-[#7C3AED] border-[#7C3AED] text-foreground shadow-lg shadow-purple-500/20" 
              ...
              >
                ...
                {postCount > 0 && (
                  <Badge className={`mt-2 ${isSelected ? "bg-white/20 text-foreground" : "bg-[#7C3AED]/20 text-[#7C3AED]"}`}>
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="flex items-center justify-between">
             <h3 className="text-lg font-bold text-foreground flex items-center gap-2 font-space">
